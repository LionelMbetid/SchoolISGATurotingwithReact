...
export default function MySessions() {
  ...
  useEffect(() => {
    ...
    axiosClient.get(`session/getMySessions/${user.id}`, { params: { page: page } }).then(({ data }) => {
      setIsLoading(false);
  ...
  function search(e) {
    ...
    console.log(keyword);
    setIsLoading(true);
    axiosClient.get(`session/getMySessions/${user.id}/${keyword}`, { params: { page: page } }).then(({ data }) => {
  ...
  return (
    <div class="p-4">
      <div className="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-black dark:text-white">My Sessions</h1>
